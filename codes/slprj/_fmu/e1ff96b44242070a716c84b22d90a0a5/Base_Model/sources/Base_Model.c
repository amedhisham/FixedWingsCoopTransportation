...
void Base_Model_step(void)
{
  ...
  memcpy(&Base_Model_Y.Drone_Positions[0], &Base_Model_DW.UnitDelay_DSTATE[0],
         12U * sizeof(real_T));
  Base_Model_Y.Drones_LinVelocity[0] = Base_Model_DW.UnitDelay_DSTATE_l[0];
  ...
  Base_Model_Y.Drones_LinVelocity[1] = Base_Model_DW.UnitDelay_DSTATE_l[1];
  ...
  Base_Model_Y.Drones_LinVelocity[2] = Base_Model_DW.UnitDelay_DSTATE_l[2];
  ...
  Base_Model_DW.UnitDelay_DSTATE_l[0] = tmp_a[0];
  ...
  Base_Model_DW.UnitDelay_DSTATE_k[0] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_c[0] = tmp_a[1];
  Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[1] +=
  ...
  Base_Model_DW.UnitDelay_DSTATE_l[1] = tmp_a[0];
  ...
  Base_Model_DW.UnitDelay_DSTATE_k[1] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_c[1] = tmp_a[1];
  Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[2] +=
  ...
  Base_Model_DW.UnitDelay_DSTATE_l[2] = tmp_a[0];
  ...
  Base_Model_DW.UnitDelay_DSTATE_k[2] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_c[2] = tmp_a[1];
  fmu_LogOutput();
}
...
{
  {
    ...
    Base_Model_DW.UnitDelay_DSTATE_l[0] =
      Base_Model_P.UnitDelay_InitialCondition_h;
    ...
    Base_Model_DW.UnitDelay_DSTATE_l[1] =
      Base_Model_P.UnitDelay_InitialCondition_h;
    ...
    Base_Model_DW.UnitDelay_DSTATE_c[1] =
      Base_Model_P.UnitDelay_InitialCondition_c;
    Base_Model_DW.UnitDelay_DSTATE_l[2] =
      Base_Model_P.UnitDelay_InitialCondition_h;
