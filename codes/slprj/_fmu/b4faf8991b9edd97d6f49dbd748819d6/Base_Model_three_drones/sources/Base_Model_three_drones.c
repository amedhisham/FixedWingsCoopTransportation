...
real_T Attachment_Point_Vectors[9] = { 0.0, 0.66666666666666663, 0.0,
  -0.57735026918962584, -0.33333333333333331, 0.0, 0.57735026918962584,
...
void Base_Model_three_drones_step(void)
{
  ...
  for (i = 0; i <= 6; i += 2) {
    ...
    tmp_5 = _mm_add_pd(tmp_5, _mm_loadu_pd
                       (&Base_Model_three_drones_P.Constant1_Value[i]));
    _mm_storeu_pd(&rtb_Transpose[i], tmp_5);
    _mm_storeu_pd(&Base_Model_three_drones_Y.Load_Orientation[i], tmp_5);
  }

  for (i = 8; i < 9; i++) {
    localProduct = Base_Model_three_drones_DW.DiscreteTimeIntegrator2_DSTATE[i]
      + Base_Model_three_drones_P.Constant1_Value[i];
    rtb_Transpose[i] = localProduct;
    Base_Model_three_drones_Y.Load_Orientation[i] = localProduct;
  }

  rtb_Transpose_0[0] = Base_Model_three_drones_P.Constant_Value;
  rtb_Transpose_0[3] = Base_Model_three_drones_P.Gain_Gain *
    Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[2];
  rtb_Transpose_0[6] =
    Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[1];
  rtb_Transpose_0[1] =
    Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[2];
  rtb_Transpose_0[4] = Base_Model_three_drones_P.Constant_Value;
  tmp_5 = _mm_mul_pd(_mm_set_pd(Base_Model_three_drones_P.Gain2_Gain,
  ...
  rtb_Transpose_0[7] = tmp_6[0];
  rtb_Transpose_0[2] = tmp_6[1];
  rtb_Transpose_0[5] =
    Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[0];
  rtb_Transpose_0[8] = Base_Model_three_drones_P.Constant_Value;
  for (i = 0; i < 3; i++) {
    rtb_RL_dot_0 = 0.0;
    rtb_Gain = 0.0;
    rtb_RL_dot_1 = 0.0;
    for (i_0 = 0; i_0 < 3; i_0++) {
      Desired_Cable_Forces = rtb_Transpose_0[3 * i + i_0];
  ...
  tmp_5 = _mm_set1_pd(localProduct);
  _mm_storeu_pd(&rtb_Transpose1[0], _mm_div_pd(_mm_loadu_pd
    (&Base_Model_three_drones_U.Desired_Cable_Forces[0]), tmp_5));
  rtb_Transpose1[2] = Base_Model_three_drones_U.Desired_Cable_Forces[2] /
    localProduct;
  for (i = 0; i < 3; i++) {
    tmp_7 = _mm_sub_pd(_mm_loadu_pd(&Base_Model_three_drones_P.Constant_Value_m
      [3 * i]), _mm_mul_pd(_mm_loadu_pd(&rtb_Transpose1[0]), _mm_set1_pd
      (rtb_Transpose1[i])));
    _mm_storeu_pd(&rtb_Transpose_0[3 * i], tmp_7);
    i_0 = 3 * i + 2;
    rtb_Transpose_0[i_0] = Base_Model_three_drones_P.Constant_Value_m[i_0] -
      rtb_Transpose1[2] * rtb_Transpose1[i];
  }
  ...
  for (i = 0; i <= 0; i += 2) {
    tmp_7 = _mm_loadu_pd(&rtb_Transpose_0[i + 3]);
    tmp_3 = _mm_loadu_pd(&rtb_Transpose_0[i]);
    tmp_4 = _mm_loadu_pd(&rtb_Transpose_0[i + 6]);
    _mm_storeu_pd(&rtb_Product4[i], _mm_mul_pd(_mm_div_pd(_mm_add_pd(_mm_add_pd
      (_mm_mul_pd(tmp_7, _mm_set1_pd(Desired_Cable_Forces_Derivatives)),
       _mm_mul_pd(tmp_3, _mm_set1_pd(Desired_Cable_Forces_Derivatives_0))),
      _mm_mul_pd(tmp_4, _mm_set1_pd(Desired_Cable_Forces_Derivatives_1))), tmp_5),
      _mm_set1_pd(Cable_Resting_Length)));
  }

  for (i = 2; i < 3; i++) {
    rtb_Product4[i] = ((rtb_Transpose_0[i + 3] *
                        Desired_Cable_Forces_Derivatives + rtb_Transpose_0[i] *
                        Desired_Cable_Forces_Derivatives_0) + rtb_Transpose_0[i
                       + 6] * Desired_Cable_Forces_Derivatives_1) / localProduct
      * Cable_Resting_Length;
  }

  rtb_RL_dot_o[0] = Base_Model_three_drones_P.Constant_Value_g;
  rtb_RL_dot_o[3] = Base_Model_three_drones_P.Gain_Gain_n *
    Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[2];
  rtb_RL_dot_o[6] = Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[1];
  rtb_RL_dot_o[1] = Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[2];
  rtb_RL_dot_o[4] = Base_Model_three_drones_P.Constant_Value_g;
  tmp_5 = _mm_mul_pd(_mm_set_pd(Base_Model_three_drones_P.Gain2_Gain_o,
    Base_Model_three_drones_P.Gain1_Gain_d), _mm_loadu_pd
                     (&Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[
                      0]));
  _mm_storeu_pd(&tmp_6[0], tmp_5);
  rtb_RL_dot_o[7] = tmp_6[0];
  rtb_RL_dot_o[2] = tmp_6[1];
  rtb_RL_dot_o[5] = Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[0];
  rtb_RL_dot_o[8] = Base_Model_three_drones_P.Constant_Value_g;
  rtb_RL_dot_0 = 0.0;
  rtb_Gain = 0.0;
  rtb_RL_dot_1 = 0.0;
  for (i = 0; i < 3; i++) {
    tmp_5 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&rtb_RL_dot_o[3 * i]),
      _mm_set1_pd(Attachment_Point_Vectors[i])), _mm_set_pd(rtb_Gain,
      rtb_RL_dot_0));
    _mm_storeu_pd(&tmp_6[0], tmp_5);
    rtb_RL_dot_0 = tmp_6[0];
    rtb_Gain = tmp_6[1];
    rtb_RL_dot_1 += rtb_RL_dot_o[3 * i + 2] * Attachment_Point_Vectors[i];
  }

  Desired_Cable_Forces = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_Transpose1[i] = ((rtb_Transpose[i + 3] * rtb_Gain + rtb_Transpose[i] *
                          rtb_RL_dot_0) + rtb_Transpose[i + 6] * rtb_RL_dot_1) +
  ...
  rtb_Force_Sum[2] = Base_Model_three_drones_U.Desired_Cable_Forces[5] /
    localProduct;
  for (i = 0; i < 3; i++) {
    tmp_5 = _mm_sub_pd(_mm_loadu_pd
                       (&Base_Model_three_drones_P.Constant1_Value_k[3 * i]),
                       _mm_mul_pd(_mm_loadu_pd(&rtb_Force_Sum[0]), _mm_set1_pd
      (rtb_Force_Sum[i])));
    _mm_storeu_pd(&rtb_Transpose_0[3 * i], tmp_5);
    i_0 = 3 * i + 2;
    rtb_Transpose_0[i_0] = Base_Model_three_drones_P.Constant1_Value_k[i_0] -
      rtb_Force_Sum[2] * rtb_Force_Sum[i];
  }
  ...
  for (i = 0; i < 3; i++) {
    rtb_Product5[i] = ((rtb_Transpose_0[i + 3] *
                        Desired_Cable_Forces_Derivatives + rtb_Transpose_0[i] *
                        Desired_Cable_Forces_Derivatives_0) + rtb_Transpose_0[i
                       + 6] * Desired_Cable_Forces_Derivatives_1) / localProduct
      * Cable_Resting_Length;
    ...
    rtb_RL_dot_0 = tmp_6[0];
    rtb_Gain = tmp_6[1];
    rtb_RL_dot_1 += rtb_RL_dot_o[3 * i + 2] * Desired_Cable_Forces;
  }

  Desired_Cable_Forces = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_pH2_dot[i] = ((rtb_Transpose[i + 3] * rtb_Gain + rtb_Transpose[i] *
                       rtb_RL_dot_0) + rtb_Transpose[i + 6] * rtb_RL_dot_1) +
      Base_Model_three_drones_DW.DiscreteTimeIntegrator_DSTATE[i];
  ...
  rtb_Force_Sum[2] = Base_Model_three_drones_U.Desired_Cable_Forces[8] /
    localProduct;
  for (i = 0; i < 3; i++) {
    tmp_5 = _mm_sub_pd(_mm_loadu_pd(&Base_Model_three_drones_P.Constant2_Value[3
      * i]), _mm_mul_pd(_mm_loadu_pd(&rtb_Force_Sum[0]), _mm_set1_pd
                        (rtb_Force_Sum[i])));
    _mm_storeu_pd(&rtb_Transpose_0[3 * i], tmp_5);
    i_0 = 3 * i + 2;
    rtb_Transpose_0[i_0] = Base_Model_three_drones_P.Constant2_Value[i_0] -
      rtb_Force_Sum[2] * rtb_Force_Sum[i];
  }
  ...
  for (i = 0; i < 3; i++) {
    rtb_Product6[i] = ((rtb_Transpose_0[i + 3] *
                        Desired_Cable_Forces_Derivatives + rtb_Transpose_0[i] *
                        Desired_Cable_Forces_Derivatives_0) + rtb_Transpose_0[i
                       + 6] * Desired_Cable_Forces_Derivatives_1) / localProduct
      * Cable_Resting_Length;
  ...
  for (i = 0; i < 3; i++) {
    localProduct = rtb_Transpose[i];
    Desired_Cable_Forces = localProduct * rtb_RL_dot_0;
    rtb_Transpose_0[3 * i] = localProduct;
    localProduct = rtb_Transpose[i + 3];
    Desired_Cable_Forces += localProduct * rtb_Gain;
    rtb_Transpose_0[3 * i + 1] = localProduct;
    localProduct = rtb_Transpose[i + 6];
    rtb_Transpose_0[3 * i + 2] = localProduct;
    rtb_Force_Sum[i] = (localProduct * rtb_RL_dot_1 + Desired_Cable_Forces) +
      Base_Model_three_drones_DW.DiscreteTimeIntegrator_DSTATE[i];
  }

  memcpy(&rtb_Transpose[0], &rtb_Transpose_0[0], 9U * sizeof(real_T));
  rtb_Transpose_0[0] = Base_Model_three_drones_P.Constant_Value_m4;
  rtb_Transpose_0[3] = Base_Model_three_drones_P.Gain_Gain_i *
    Attachment_Point_Vectors[2];
  rtb_Transpose_0[6] = Attachment_Point_Vectors[1];
  rtb_Transpose_0[1] = Attachment_Point_Vectors[2];
  rtb_Transpose_0[4] = Base_Model_three_drones_P.Constant_Value_m4;
  _mm_storeu_pd(&tmp_6[0], _mm_mul_pd(_mm_set_pd
    (Base_Model_three_drones_P.Gain2_Gain_e,
     Base_Model_three_drones_P.Gain1_Gain_dl), _mm_loadu_pd
    (&Attachment_Point_Vectors[0])));
  rtb_Transpose_0[7] = tmp_6[0];
  rtb_Transpose_0[2] = tmp_6[1];
  rtb_Transpose_0[5] = Attachment_Point_Vectors[0];
  rtb_Transpose_0[8] = Base_Model_three_drones_P.Constant_Value_m4;
  tmp[0] = Base_Model_three_drones_P.Constant_Value_f;
  tmp[3] = Base_Model_three_drones_P.Gain_Gain_g * Attachment_Point_Vectors[5];
  tmp[6] = Attachment_Point_Vectors[4];
  tmp[1] = Attachment_Point_Vectors[5];
  tmp[4] = Base_Model_three_drones_P.Constant_Value_f;
  _mm_storeu_pd(&tmp_6[0], _mm_mul_pd(_mm_set_pd
  ...
  tmp[7] = tmp_6[0];
  tmp[2] = tmp_6[1];
  tmp[5] = Attachment_Point_Vectors[3];
  tmp[8] = Base_Model_three_drones_P.Constant_Value_f;
  for (i = 0; i < 3; i++) {
    Desired_Cable_Forces = 0.0;
    localProduct = 0.0;
    rtb_RL_dot_0 = 0.0;
    for (i_0 = 0; i_0 < 3; i_0++) {
      tmp_8 = 3 * i + i_0;
      rtb_Gain = rtb_Transpose[tmp_8];
      tmp_5 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&rtb_Transpose_0[3 * i_0]),
        _mm_set1_pd(rtb_Gain)), _mm_set_pd(localProduct, Desired_Cable_Forces));
      _mm_storeu_pd(&tmp_6[0], tmp_5);
      Desired_Cable_Forces = tmp_6[0];
      localProduct = tmp_6[1];
      rtb_RL_dot_0 += rtb_Transpose_0[3 * i_0 + 2] * rtb_Gain;
      tmp_0[tmp_8] = 0.0;
    }

    i_0 = 3 * i + 2;
    rtb_RL_dot_o[i_0] = rtb_RL_dot_0;
    tmp_8 = 3 * i + 1;
    rtb_RL_dot_o[tmp_8] = localProduct;
    rtb_RL_dot_o[3 * i] = Desired_Cable_Forces;
    Desired_Cable_Forces = tmp_0[3 * i];
    localProduct = tmp_0[tmp_8];
    rtb_RL_dot_0 = tmp_0[i_0];
    for (i_1 = 0; i_1 < 3; i_1++) {
      rtb_Gain = rtb_Transpose[3 * i + i_1];
      tmp_5 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&tmp[3 * i_1]), _mm_set1_pd
        (rtb_Gain)), _mm_set_pd(localProduct, Desired_Cable_Forces));
      _mm_storeu_pd(&tmp_6[0], tmp_5);
      Desired_Cable_Forces = tmp_6[0];
      localProduct = tmp_6[1];
      rtb_RL_dot_0 += tmp[3 * i_1 + 2] * rtb_Gain;
    }

    tmp_0[i_0] = rtb_RL_dot_0;
    tmp_0[tmp_8] = localProduct;
  ...
  for (i = 0; i < 3; i++) {
    tmp_5 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&rtb_RL_dot_o[3 * i]),
      _mm_set1_pd(Base_Model_three_drones_U.Desired_Cable_Forces[i])),
                       _mm_set_pd(localProduct, Desired_Cable_Forces));
    _mm_storeu_pd(&tmp_6[0], tmp_5);
    Desired_Cable_Forces = tmp_6[0];
    localProduct = tmp_6[1];
    rtb_RL_dot_0 += rtb_RL_dot_o[3 * i + 2] *
      Base_Model_three_drones_U.Desired_Cable_Forces[i];
    tmp_1[i] = 0.0;
  }

  rtb_Torque_Sum_0[2] = rtb_RL_dot_0;
  rtb_Torque_Sum_0[1] = localProduct;
  rtb_Torque_Sum_0[0] = Desired_Cable_Forces;
  rtb_Transpose_0[0] = Base_Model_three_drones_P.Constant_Value_i;
  rtb_Transpose_0[3] = Base_Model_three_drones_P.Gain_Gain_c *
    Attachment_Point_Vectors[8];
  rtb_Transpose_0[6] = Attachment_Point_Vectors[7];
  rtb_Transpose_0[1] = Attachment_Point_Vectors[8];
  rtb_Transpose_0[4] = Base_Model_three_drones_P.Constant_Value_i;
  _mm_storeu_pd(&tmp_6[0], _mm_mul_pd(_mm_set_pd
  ...
  rtb_Transpose_0[7] = tmp_6[0];
  rtb_Transpose_0[2] = tmp_6[1];
  rtb_Transpose_0[5] = Attachment_Point_Vectors[6];
  rtb_Transpose_0[8] = Base_Model_three_drones_P.Constant_Value_i;
  for (i = 0; i < 3; i++) {
    Desired_Cable_Forces = Base_Model_three_drones_U.Desired_Cable_Forces[i + 3];
    tmp_1[0] += tmp_0[3 * i] * Desired_Cable_Forces;
    i_0 = 3 * i + 1;
    tmp_1[1] += tmp_0[i_0] * Desired_Cable_Forces;
    tmp_8 = 3 * i + 2;
    tmp_1[2] += tmp_0[tmp_8] * Desired_Cable_Forces;
    Desired_Cable_Forces = 0.0;
    localProduct = 0.0;
    rtb_RL_dot_0 = 0.0;
    for (i_1 = 0; i_1 < 3; i_1++) {
      rtb_Gain = rtb_Transpose[3 * i + i_1];
      tmp_5 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&rtb_Transpose_0[3 * i_1]),
        _mm_set1_pd(rtb_Gain)), _mm_set_pd(localProduct, Desired_Cable_Forces));
      _mm_storeu_pd(&tmp_6[0], tmp_5);
      Desired_Cable_Forces = tmp_6[0];
      localProduct = tmp_6[1];
      rtb_RL_dot_0 += rtb_Transpose_0[3 * i_1 + 2] * rtb_Gain;
    }

    rtb_RL_dot_o[tmp_8] = rtb_RL_dot_0;
    rtb_RL_dot_o[i_0] = localProduct;
    rtb_RL_dot_o[3 * i] = Desired_Cable_Forces;
  }
  ...
  for (i = 0; i <= 0; i += 2) {
    tmp_5 = _mm_loadu_pd(&rtb_RL_dot_o[i + 3]);
    tmp_7 = _mm_loadu_pd(&rtb_RL_dot_o[i]);
    tmp_3 = _mm_loadu_pd(&rtb_RL_dot_o[i + 6]);
    tmp_4 = _mm_loadu_pd(&rtb_Torque_Sum_0[i]);
    tmp_2 = _mm_loadu_pd(&tmp_1[i]);
    _mm_storeu_pd(&rtb_Torque_Sum[i], _mm_add_pd(_mm_add_pd(_mm_add_pd
      (_mm_mul_pd(tmp_5, _mm_set1_pd(Desired_Cable_Forces)), _mm_mul_pd(tmp_7,
      _mm_set1_pd(rtb_RL_dot_0))), _mm_mul_pd(tmp_3, _mm_set1_pd(rtb_Gain))),
      _mm_add_pd(tmp_4, tmp_2)));
    tmp_5 = _mm_loadu_pd
      (&Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[i]);
    _mm_storeu_pd(&rtb_Sum3[i], _mm_mul_pd(_mm_set1_pd
      (Base_Model_three_drones_P.Gain1_Gain_fl), tmp_5));
    _mm_storeu_pd(&rtb_MatrixMultiply5[i], _mm_set1_pd(0.0));
  }

  for (i = 2; i < 3; i++) {
    rtb_Torque_Sum[i] = ((rtb_RL_dot_o[i + 3] * Desired_Cable_Forces +
                          rtb_RL_dot_o[i] * rtb_RL_dot_0) + rtb_RL_dot_o[i + 6] *
                         rtb_Gain) + (rtb_Torque_Sum_0[i] + tmp_1[i]);
  ...
  rt_invd3x3_snf(Load_Inertia_Matrix, rtb_Transpose_0);
  ...
  Desired_Cable_Forces = 0.0;
  for (i = 0; i < 3; i++) {
    tmp_5 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&rtb_Transpose_0[3 * i]),
      _mm_set1_pd(rtb_Torque_Sum_0[i])), _mm_set_pd(rtb_RL_dot_1, rtb_Gain));
    _mm_storeu_pd(&tmp_6[0], tmp_5);
    rtb_Gain = tmp_6[0];
    rtb_RL_dot_1 = tmp_6[1];
    Desired_Cable_Forces += rtb_Transpose_0[3 * i + 2] * rtb_Torque_Sum_0[i];
  }

  tmp_5 = _mm_set_pd(Base_Model_three_drones_P.DiscreteTimeIntegrator1_gainval_g,
                     Base_Model_three_drones_P.DiscreteTimeIntegrator3_gainval);
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_mul_pd(tmp_5, _mm_set_pd
    (Base_Model_three_drones_DW.UnitDelay_DSTATE[0], rtb_Gain)), _mm_set_pd
    (Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_f[0],
     Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[0])));
  Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[0] = tmp_6[0];
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_f[0] = tmp_6[1];
  tmp_7 = _mm_set_pd(Base_Model_three_drones_P.DiscreteTimeIntegrator1_gainval_i,
                     Base_Model_three_drones_P.DiscreteTimeIntegrator1_gainval_n);
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_mul_pd(tmp_7, _mm_set_pd
    (Base_Model_three_drones_DW.UnitDelay_DSTATE_k[0],
     Base_Model_three_drones_DW.UnitDelay_DSTATE_b[0])), _mm_set_pd
    (Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_l[0],
     Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_g[0])));
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_g[0] = tmp_6[0];
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_l[0] = tmp_6[1];
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_set_pd(rtb_Product5[0], rtb_Product4[0]),
    _mm_set_pd(rtb_pH2_dot[0], rtb_Transpose1[0])));
  Base_Model_three_drones_DW.UnitDelay_DSTATE[0] = tmp_6[0];
  Base_Model_three_drones_DW.UnitDelay_DSTATE_b[0] = tmp_6[1];
  ...
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_mul_pd(tmp_5, _mm_set_pd
    ...
    (Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_f[1],
     Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[1])));
  Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[1] = tmp_6[0];
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_f[1] = tmp_6[1];
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_mul_pd(tmp_7, _mm_set_pd
    (Base_Model_three_drones_DW.UnitDelay_DSTATE_k[1],
     Base_Model_three_drones_DW.UnitDelay_DSTATE_b[1])), _mm_set_pd
    (Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_l[1],
     Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_g[1])));
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_g[1] = tmp_6[0];
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_l[1] = tmp_6[1];
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_set_pd(rtb_Product5[1], rtb_Product4[1]),
    _mm_set_pd(rtb_pH2_dot[1], rtb_Transpose1[1])));
  Base_Model_three_drones_DW.UnitDelay_DSTATE[1] = tmp_6[0];
  Base_Model_three_drones_DW.UnitDelay_DSTATE_b[1] = tmp_6[1];
  ...
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_mul_pd(tmp_5, _mm_set_pd
    ...
    _mm_set_pd(Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_f[2],
               Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[2])));
  Base_Model_three_drones_DW.DiscreteTimeIntegrator3_DSTATE[2] = tmp_6[0];
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_f[2] = tmp_6[1];
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_mul_pd(tmp_7, _mm_set_pd
    (Base_Model_three_drones_DW.UnitDelay_DSTATE_k[2],
     Base_Model_three_drones_DW.UnitDelay_DSTATE_b[2])), _mm_set_pd
    (Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_l[2],
     Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_g[2])));
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_g[2] = tmp_6[0];
  Base_Model_three_drones_DW.DiscreteTimeIntegrator1_DSTATE_l[2] = tmp_6[1];
  _mm_storeu_pd(&tmp_6[0], _mm_add_pd(_mm_set_pd(rtb_Product5[2], rtb_Product4[2]),
    _mm_set_pd(rtb_pH2_dot[2], rtb_Transpose1[2])));
  Base_Model_three_drones_DW.UnitDelay_DSTATE[2] = tmp_6[0];
  Base_Model_three_drones_DW.UnitDelay_DSTATE_b[2] = tmp_6[1];
