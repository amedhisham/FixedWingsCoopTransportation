...
typedef struct {
  ...
  real_T UnitDelay_DSTATE[12];
  real_T UnitDelay_DSTATE_n[3];
  real_T UnitDelay_DSTATE_o[3];
  real_T UnitDelay_DSTATE_c[3];
  real_T UnitDelay_DSTATE_i[3];
...
struct P_Base_Model_T_ {
  ...
  real_T UnitDelay_InitialCondition_k;
  real_T UnitDelay_InitialCondition_b;
  real_T UnitDelay_InitialCondition_e;
