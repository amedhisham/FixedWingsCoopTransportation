...
void Base_Model_step(void)
{
  ...
  real_T rtb_Product7[3];
  real_T rtb_Sum4[3];
  real_T rtb_Transpose1[3];
  real_T rtb_Transpose2[3];
  real_T rtb_pH1_dot[3];
  real_T rtb_pH2_dot[3];
  real_T rtb_pH3_dot[3];
  real_T rtb_pH4_dot[3];
  real_T tmp_3[3];
  real_T tmp_5[3];
  real_T tmp_6[3];
  real_T tmp_a[2];
  ...
  real_T rtb_RL_dot_0;
  real_T rtb_Sum_pp_idx_0;
  real_T rtb_Sum_pp_idx_1;
  real_T rtb_Sum_pp_idx_2;
  int32_T i;
  int32_T i_0;
  ...
  for (i = 0; i < 3; i++) {
    ...
    rtb_Gain = 0.0;
    for (i_0 = 0; i_0 < 3; i_0++) {
      DiscreteTimeIntegrator1_DSTATE = tmp[3 * i + i_0];
      tmp_c = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd
        (&Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[3 * i_0]), _mm_set1_pd
        (DiscreteTimeIntegrator1_DSTATE)), _mm_set_pd(rtb_RL_dot_0, localProduct));
      _mm_storeu_pd(&tmp_a[0], tmp_c);
      localProduct = tmp_a[0];
      rtb_RL_dot_0 = tmp_a[1];
      rtb_Gain += Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[3 * i_0 + 2] *
        DiscreteTimeIntegrator1_DSTATE;
    }

    rtb_RL_dot[3 * i + 2] = rtb_Gain;
    rtb_RL_dot[3 * i + 1] = rtb_RL_dot_0;
    rtb_RL_dot[3 * i] = localProduct;
  }
  ...
  memcpy(&Base_Model_Y.Drone_Positions[0], &Base_Model_DW.UnitDelay_DSTATE[0],
         12U * sizeof(real_T));
  Base_Model_Y.Drones_LinVelocity[0] = Base_Model_DW.UnitDelay_DSTATE_n[0];
  Base_Model_Y.Drones_LinVelocity[3] = Base_Model_DW.UnitDelay_DSTATE_o[0];
  Base_Model_Y.Drones_LinVelocity[6] = Base_Model_DW.UnitDelay_DSTATE_c[0];
  Base_Model_Y.Drones_LinVelocity[9] = Base_Model_DW.UnitDelay_DSTATE_i[0];
  Base_Model_Y.Drones_LinVelocity[1] = Base_Model_DW.UnitDelay_DSTATE_n[1];
  Base_Model_Y.Drones_LinVelocity[4] = Base_Model_DW.UnitDelay_DSTATE_o[1];
  Base_Model_Y.Drones_LinVelocity[7] = Base_Model_DW.UnitDelay_DSTATE_c[1];
  Base_Model_Y.Drones_LinVelocity[10] = Base_Model_DW.UnitDelay_DSTATE_i[1];
  Base_Model_Y.Drones_LinVelocity[2] = Base_Model_DW.UnitDelay_DSTATE_n[2];
  Base_Model_Y.Drones_LinVelocity[5] = Base_Model_DW.UnitDelay_DSTATE_o[2];
  Base_Model_Y.Drones_LinVelocity[8] = Base_Model_DW.UnitDelay_DSTATE_c[2];
  Base_Model_Y.Drones_LinVelocity[11] = Base_Model_DW.UnitDelay_DSTATE_i[2];
  ...
  _mm_storeu_pd(&rtb_MatrixMultiply10[0], _mm_div_pd(_mm_loadu_pd
    (&Base_Model_U.Desired_Cable_Forces[0]), tmp_c));
  rtb_MatrixMultiply10[2] = Base_Model_U.Desired_Cable_Forces[2] / localProduct;
  for (i = 0; i < 3; i++) {
    tmp_b = _mm_sub_pd(_mm_loadu_pd(&Base_Model_P.Constant_Value_m[3 * i]),
                       _mm_mul_pd(_mm_loadu_pd(&rtb_MatrixMultiply10[0]),
      _mm_set1_pd(rtb_MatrixMultiply10[i])));
    _mm_storeu_pd(&tmp[3 * i], tmp_b);
    i_0 = 3 * i + 2;
    tmp[i_0] = Base_Model_P.Constant_Value_m[i_0] - rtb_MatrixMultiply10[2] *
      rtb_MatrixMultiply10[i];
  }

  rtb_RL_dot_0 = Base_Model_U.Desired_Cable_Forces_Derivatives[1];
  rtb_Gain = Base_Model_U.Desired_Cable_Forces_Derivatives[0];
  rtb_MatrixMultiply5_idx_1 = Base_Model_U.Desired_Cable_Forces_Derivatives[2];
  for (i = 0; i <= 0; i += 2) {
    ...
    _mm_storeu_pd(&rtb_Product4[i], _mm_mul_pd(_mm_div_pd(_mm_add_pd(_mm_add_pd
      (_mm_mul_pd(tmp_b, _mm_set1_pd(rtb_RL_dot_0)), _mm_mul_pd(tmp_8,
      _mm_set1_pd(rtb_Gain))), _mm_mul_pd(tmp_9, _mm_set1_pd
      (rtb_MatrixMultiply5_idx_1))), tmp_c), _mm_set1_pd(Cable_Resting_Length)));
  }

  for (i = 2; i < 3; i++) {
    rtb_Product4[i] = ((tmp[i + 3] * rtb_RL_dot_0 + tmp[i] * rtb_Gain) + tmp[i +
                       6] * rtb_MatrixMultiply5_idx_1) / localProduct *
  ...
  rtb_Sum_pp_idx_0 = 0.0;
  rtb_MatrixMultiply5_idx_0 = 0.0;
  rtb_Sum_pp_idx_1 = 0.0;
  for (i = 0; i < 3; i++) {
    tmp_c = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&rtb_Transpose[3 * i]),
      _mm_set1_pd(Attachment_Point_Vectors[i])), _mm_set_pd
                       (rtb_MatrixMultiply5_idx_0, rtb_Sum_pp_idx_0));
    _mm_storeu_pd(&tmp_a[0], tmp_c);
    rtb_Sum_pp_idx_0 = tmp_a[0];
    rtb_MatrixMultiply5_idx_0 = tmp_a[1];
    rtb_Sum_pp_idx_1 += rtb_Transpose[3 * i + 2] * Attachment_Point_Vectors[i];
  }

  DiscreteTimeIntegrator1_DSTATE = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_pH1_dot[i] = ((Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i + 3] *
  ...
  _mm_storeu_pd(&rtb_Transpose1[0], _mm_div_pd(_mm_loadu_pd
    (&Base_Model_U.Desired_Cable_Forces[3]), _mm_set1_pd(localProduct)));
  rtb_Transpose1[2] = Base_Model_U.Desired_Cable_Forces[5] / localProduct;
  for (i = 0; i < 3; i++) {
    tmp_c = _mm_sub_pd(_mm_loadu_pd(&Base_Model_P.Constant1_Value[3 * i]),
                       _mm_mul_pd(_mm_loadu_pd(&rtb_Transpose1[0]), _mm_set1_pd
      (rtb_Transpose1[i])));
    _mm_storeu_pd(&tmp[3 * i], tmp_c);
    i_0 = 3 * i + 2;
    tmp[i_0] = Base_Model_P.Constant1_Value[i_0] - rtb_Transpose1[2] *
      rtb_Transpose1[i];
  }
  ...
  rtb_Gain = Base_Model_U.Desired_Cable_Forces_Derivatives[3];
  rtb_MatrixMultiply5_idx_1 = Base_Model_U.Desired_Cable_Forces_Derivatives[5];
  for (i = 0; i < 3; i++) {
    rtb_Product5[i] = ((tmp[i + 3] * rtb_RL_dot_0 + tmp[i] * rtb_Gain) + tmp[i +
                       6] * rtb_MatrixMultiply5_idx_1) / localProduct *
      Cable_Resting_Length;
    ...
    rtb_Sum_pp_idx_0 = tmp_a[0];
    rtb_MatrixMultiply5_idx_0 = tmp_a[1];
    rtb_Sum_pp_idx_1 += rtb_Transpose[3 * i + 2] *
      DiscreteTimeIntegrator1_DSTATE;
  }

  DiscreteTimeIntegrator1_DSTATE = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_pH2_dot[i] = ((Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i + 3] *
                       rtb_MatrixMultiply5_idx_0 +
                       Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i] *
                       rtb_Sum_pp_idx_0) +
                      Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i + 6] *
  ...
  _mm_storeu_pd(&rtb_Transpose2[0], _mm_div_pd(_mm_loadu_pd
    (&Base_Model_U.Desired_Cable_Forces[6]), _mm_set1_pd(localProduct)));
  rtb_Transpose2[2] = Base_Model_U.Desired_Cable_Forces[8] / localProduct;
  for (i = 0; i < 3; i++) {
    tmp_c = _mm_sub_pd(_mm_loadu_pd(&Base_Model_P.Constant2_Value[3 * i]),
                       _mm_mul_pd(_mm_loadu_pd(&rtb_Transpose2[0]), _mm_set1_pd
      (rtb_Transpose2[i])));
    _mm_storeu_pd(&tmp[3 * i], tmp_c);
    i_0 = 3 * i + 2;
    tmp[i_0] = Base_Model_P.Constant2_Value[i_0] - rtb_Transpose2[2] *
      rtb_Transpose2[i];
  }
  ...
  rtb_Gain = Base_Model_U.Desired_Cable_Forces_Derivatives[6];
  rtb_MatrixMultiply5_idx_1 = Base_Model_U.Desired_Cable_Forces_Derivatives[8];
  for (i = 0; i < 3; i++) {
    rtb_Product6[i] = ((tmp[i + 3] * rtb_RL_dot_0 + tmp[i] * rtb_Gain) + tmp[i +
                       6] * rtb_MatrixMultiply5_idx_1) / localProduct *
      Cable_Resting_Length;
  ...
  DiscreteTimeIntegrator1_DSTATE = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_pH3_dot[i] = ((Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i + 3] *
                       rtb_MatrixMultiply5_idx_0 +
                       Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i] *
                       rtb_Sum_pp_idx_0) +
                      Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i + 6] *
  ...
  _mm_storeu_pd(&rtb_MatrixMultiply9[0], _mm_div_pd(_mm_loadu_pd
    (&Base_Model_U.Desired_Cable_Forces[9]), _mm_set1_pd(localProduct)));
  rtb_MatrixMultiply9[2] = Base_Model_U.Desired_Cable_Forces[11] / localProduct;
  for (i = 0; i < 3; i++) {
    tmp_c = _mm_sub_pd(_mm_loadu_pd(&Base_Model_P.Constant3_Value[3 * i]),
                       _mm_mul_pd(_mm_loadu_pd(&rtb_MatrixMultiply9[0]),
      _mm_set1_pd(rtb_MatrixMultiply9[i])));
    _mm_storeu_pd(&tmp[3 * i], tmp_c);
    i_0 = 3 * i + 2;
    tmp[i_0] = Base_Model_P.Constant3_Value[i_0] - rtb_MatrixMultiply9[2] *
  ...
  rtb_Gain = Base_Model_U.Desired_Cable_Forces_Derivatives[9];
  rtb_MatrixMultiply5_idx_1 = Base_Model_U.Desired_Cable_Forces_Derivatives[11];
  for (i = 0; i < 3; i++) {
    rtb_Product7[i] = ((tmp[i + 3] * rtb_RL_dot_0 + tmp[i] * rtb_Gain) + tmp[i +
                       6] * rtb_MatrixMultiply5_idx_1) / localProduct *
      Cable_Resting_Length;
  ...
  for (i = 0; i < 3; i++) {
    rtb_MatrixMultiply5_idx_1 = Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i];
    DiscreteTimeIntegrator1_DSTATE = rtb_MatrixMultiply5_idx_1 *
      rtb_Sum_pp_idx_0;
    tmp_c = _mm_set1_pd(rtb_MatrixMultiply5_idx_1);
    _mm_storeu_pd(&tmp_a[0], _mm_mul_pd(tmp_c, _mm_set_pd
      (Attachment_Point_Vectors[3], Attachment_Point_Vectors[0])));
    rtb_RL_dot_0 = tmp_a[0];
    localProduct = tmp_a[1];
    _mm_storeu_pd(&tmp_a[0], _mm_mul_pd(tmp_c, _mm_set_pd
      (Attachment_Point_Vectors[9], Attachment_Point_Vectors[6])));
    rtb_Gain = tmp_a[0];
    rtb_Sum_pp_idx_2 = tmp_a[1];
    rtb_Transpose[3 * i] = rtb_MatrixMultiply5_idx_1;
    rtb_MatrixMultiply5_idx_1 = Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i +
      3];
    DiscreteTimeIntegrator1_DSTATE += rtb_MatrixMultiply5_idx_1 *
      rtb_MatrixMultiply5_idx_0;
    ...
    _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_mul_pd(tmp_c, _mm_set_pd
      (Attachment_Point_Vectors[4], Attachment_Point_Vectors[1])), _mm_set_pd
      (localProduct, rtb_RL_dot_0)));
    rtb_RL_dot_0 = tmp_a[0];
    localProduct = tmp_a[1];
    _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_mul_pd(tmp_c, _mm_set_pd
      (Attachment_Point_Vectors[10], Attachment_Point_Vectors[7])), _mm_set_pd
      (rtb_Sum_pp_idx_2, rtb_Gain)));
    rtb_Transpose_tmp_0 = 3 * i + 1;
    rtb_Transpose[rtb_Transpose_tmp_0] = rtb_MatrixMultiply5_idx_1;
    rtb_MatrixMultiply5_idx_1 = Base_Model_DW.DiscreteTimeIntegrator2_DSTATE[i +
      6];
    rtb_Transpose_tmp = 3 * i + 2;
    rtb_Transpose[rtb_Transpose_tmp] = rtb_MatrixMultiply5_idx_1;
    rtb_pH4_dot[i] = (rtb_MatrixMultiply5_idx_1 * rtb_Sum_pp_idx_1 +
                      DiscreteTimeIntegrator1_DSTATE) +
      Base_Model_DW.DiscreteTimeIntegrator_DSTATE[i];
    DiscreteTimeIntegrator1_DSTATE =
      Base_Model_DW.DiscreteTimeIntegrator1_DSTATE[i];
    rtb_Sum4[i] = ((rtb_MatrixMultiply5_idx_1 * Attachment_Point_Vectors[2] +
                    rtb_RL_dot_0) + rtb_MatrixMultiply10[i] *
                   Cable_Resting_Length) + DiscreteTimeIntegrator1_DSTATE;
    rtb_MatrixMultiply10[i] = ((rtb_MatrixMultiply5_idx_1 *
      Attachment_Point_Vectors[5] + localProduct) + rtb_Transpose1[i] *
      Cable_Resting_Length) + DiscreteTimeIntegrator1_DSTATE;
    rtb_Transpose1[i] = ((rtb_MatrixMultiply5_idx_1 * Attachment_Point_Vectors[8]
                          + tmp_a[0]) + rtb_Transpose2[i] * Cable_Resting_Length)
      + DiscreteTimeIntegrator1_DSTATE;
    rtb_Transpose2[i] = ((rtb_MatrixMultiply5_idx_1 * Attachment_Point_Vectors
                          [11] + tmp_a[1]) + rtb_MatrixMultiply9[i] *
                         Cable_Resting_Length) + DiscreteTimeIntegrator1_DSTATE;
    DiscreteTimeIntegrator1_DSTATE = 0.0;
    rtb_RL_dot_0 = 0.0;
    localProduct = 0.0;
    for (i_0 = 0; i_0 < 3; i_0++) {
      ...
      rtb_RL_dot_0 = tmp_a[1];
      localProduct += tmp[3 * i_0 + 2] * rtb_Gain;
      tmp_2[tmp_d] = 0.0;
    }

    tmp_0[rtb_Transpose_tmp] = localProduct;
    tmp_0[rtb_Transpose_tmp_0] = rtb_RL_dot_0;
    tmp_0[3 * i] = DiscreteTimeIntegrator1_DSTATE;
    DiscreteTimeIntegrator1_DSTATE = tmp_2[3 * i];
    rtb_RL_dot_0 = tmp_2[rtb_Transpose_tmp_0];
    localProduct = tmp_2[rtb_Transpose_tmp];
    for (i_0 = 0; i_0 < 3; i_0++) {
      ...
      DiscreteTimeIntegrator1_DSTATE = tmp_a[0];
      rtb_RL_dot_0 = tmp_a[1];
      localProduct += tmp_1[3 * i_0 + 2] * rtb_Gain;
    }

    tmp_2[rtb_Transpose_tmp] = localProduct;
    tmp_2[rtb_Transpose_tmp_0] = rtb_RL_dot_0;
    tmp_2[3 * i] = DiscreteTimeIntegrator1_DSTATE;
  }
  ...
  localProduct = 0.0;
  for (i = 0; i < 3; i++) {
    tmp_c = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&tmp_0[3 * i]), _mm_set1_pd
      (Base_Model_U.Desired_Cable_Forces[i])), _mm_set_pd(rtb_RL_dot_0,
      DiscreteTimeIntegrator1_DSTATE));
    _mm_storeu_pd(&tmp_a[0], tmp_c);
    DiscreteTimeIntegrator1_DSTATE = tmp_a[0];
    rtb_RL_dot_0 = tmp_a[1];
    localProduct += tmp_0[3 * i + 2] * Base_Model_U.Desired_Cable_Forces[i];
    tmp_3[i] = 0.0;
  }

  rtb_MatrixMultiply9[2] = localProduct;
  rtb_MatrixMultiply9[1] = rtb_RL_dot_0;
  rtb_MatrixMultiply9[0] = DiscreteTimeIntegrator1_DSTATE;
  ...
  tmp_1[0] = Base_Model_P.Constant_Value_g4;
  tmp_1[3] = Base_Model_P.Gain_Gain_ii * Attachment_Point_Vectors[11];
  tmp_1[6] = Attachment_Point_Vectors[10];
  tmp_1[1] = Attachment_Point_Vectors[11];
  tmp_1[4] = Base_Model_P.Constant_Value_g4;
  ...
  tmp_1[7] = tmp_a[0];
  tmp_1[2] = tmp_a[1];
  tmp_1[5] = Attachment_Point_Vectors[9];
  tmp_1[8] = Base_Model_P.Constant_Value_g4;
  for (i = 0; i < 3; i++) {
    DiscreteTimeIntegrator1_DSTATE = Base_Model_U.Desired_Cable_Forces[i + 3];
    tmp_3[0] += tmp_2[3 * i] * DiscreteTimeIntegrator1_DSTATE;
    i_0 = 3 * i + 1;
    tmp_3[1] += tmp_2[i_0] * DiscreteTimeIntegrator1_DSTATE;
    tmp_d = 3 * i + 2;
    tmp_3[2] += tmp_2[tmp_d] * DiscreteTimeIntegrator1_DSTATE;
    DiscreteTimeIntegrator1_DSTATE = 0.0;
    rtb_RL_dot_0 = 0.0;
    localProduct = 0.0;
    for (rtb_Transpose_tmp_0 = 0; rtb_Transpose_tmp_0 < 3; rtb_Transpose_tmp_0++)
    {
      ...
      DiscreteTimeIntegrator1_DSTATE = tmp_a[0];
      rtb_RL_dot_0 = tmp_a[1];
      localProduct += tmp[3 * rtb_Transpose_tmp_0 + 2] * rtb_Gain;
      tmp_4[rtb_Transpose_tmp] = 0.0;
    }

    tmp_0[tmp_d] = localProduct;
    tmp_0[i_0] = rtb_RL_dot_0;
    tmp_0[3 * i] = DiscreteTimeIntegrator1_DSTATE;
    DiscreteTimeIntegrator1_DSTATE = tmp_4[3 * i];
    rtb_RL_dot_0 = tmp_4[i_0];
    localProduct = tmp_4[tmp_d];
    for (rtb_Transpose_tmp_0 = 0; rtb_Transpose_tmp_0 < 3; rtb_Transpose_tmp_0++)
    {
      rtb_Gain = rtb_Transpose[3 * i + rtb_Transpose_tmp_0];
      tmp_c = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&tmp_1[3 * rtb_Transpose_tmp_0]),
        _mm_set1_pd(rtb_Gain)), _mm_set_pd(rtb_RL_dot_0,
        DiscreteTimeIntegrator1_DSTATE));
      _mm_storeu_pd(&tmp_a[0], tmp_c);
      DiscreteTimeIntegrator1_DSTATE = tmp_a[0];
      rtb_RL_dot_0 = tmp_a[1];
      localProduct += tmp_1[3 * rtb_Transpose_tmp_0 + 2] * rtb_Gain;
    }

    tmp_4[tmp_d] = localProduct;
    tmp_4[i_0] = rtb_RL_dot_0;
    tmp_4[3 * i] = DiscreteTimeIntegrator1_DSTATE;
  }

  DiscreteTimeIntegrator1_DSTATE = Base_Model_U.Desired_Cable_Forces[7];
  localProduct = Base_Model_U.Desired_Cable_Forces[6];
  rtb_RL_dot_0 = Base_Model_U.Desired_Cable_Forces[8];
  for (i = 0; i <= 0; i += 2) {
    tmp_c = _mm_loadu_pd(&tmp_0[i + 3]);
    tmp_b = _mm_loadu_pd(&tmp_0[i]);
    tmp_8 = _mm_loadu_pd(&tmp_0[i + 6]);
    tmp_9 = _mm_loadu_pd(&rtb_MatrixMultiply9[i]);
    tmp_7 = _mm_loadu_pd(&tmp_3[i]);
    _mm_storeu_pd(&tmp_5[i], _mm_add_pd(_mm_add_pd(_mm_add_pd(_mm_mul_pd(tmp_c,
      _mm_set1_pd(DiscreteTimeIntegrator1_DSTATE)), _mm_mul_pd(tmp_b,
      _mm_set1_pd(localProduct))), _mm_mul_pd(tmp_8, _mm_set1_pd(rtb_RL_dot_0))),
      _mm_add_pd(tmp_9, tmp_7)));
    _mm_storeu_pd(&tmp_6[i], _mm_set1_pd(0.0));
  }

  for (i = 2; i < 3; i++) {
    tmp_5[i] = ((tmp_0[i + 3] * DiscreteTimeIntegrator1_DSTATE + tmp_0[i] *
                 localProduct) + tmp_0[i + 6] * rtb_RL_dot_0) +
      (rtb_MatrixMultiply9[i] + tmp_3[i]);
  }

  rtb_Sum_pp_idx_0 = Base_Model_P.Gain1_Gain_fl *
    Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[0];
  rtb_MatrixMultiply5_idx_0 = 0.0;
  rtb_Sum_pp_idx_1 = Base_Model_P.Gain1_Gain_fl *
    Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[1];
  rtb_MatrixMultiply5_idx_1 = 0.0;
  rtb_Sum_pp_idx_2 = Base_Model_P.Gain1_Gain_fl *
    Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[2];
  ...
  for (i = 0; i < 3; i++) {
    ...
    tmp_c = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd(&tmp_4[3 * i]), _mm_set1_pd
      (rtb_Gain)), _mm_set_pd(rtb_RL_dot_0, DiscreteTimeIntegrator1_DSTATE));
    _mm_storeu_pd(&tmp_a[0], tmp_c);
    DiscreteTimeIntegrator1_DSTATE = tmp_a[0];
    rtb_RL_dot_0 = tmp_a[1];
    _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_mul_pd(_mm_set_pd
      (Load_Inertia_Matrix[3 * i], tmp_4[3 * i + 2]), _mm_set_pd
  ...
  rtb_MatrixMultiply9[0] = ((rtb_Sum_pp_idx_1 * rtb_MatrixMultiply5_idx_2 -
    rtb_MatrixMultiply5_idx_1 * rtb_Sum_pp_idx_2) + (tmp_5[0] +
    DiscreteTimeIntegrator1_DSTATE)) -
    Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[0] * Load_Damping_Coef;
  DiscreteTimeIntegrator1_DSTATE = 0.0;
  rtb_MatrixMultiply9[1] = ((rtb_MatrixMultiply5_idx_0 * rtb_Sum_pp_idx_2 -
    rtb_Sum_pp_idx_0 * rtb_MatrixMultiply5_idx_2) + (tmp_5[1] + rtb_RL_dot_0)) -
    Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[1] * Load_Damping_Coef;
  rtb_RL_dot_0 = 0.0;
  rtb_MatrixMultiply9[2] = ((rtb_Sum_pp_idx_0 * rtb_MatrixMultiply5_idx_1 -
    rtb_MatrixMultiply5_idx_0 * rtb_Sum_pp_idx_1) + (tmp_5[2] + localProduct)) -
  ...
  for (i = 0; i < 3; i++) {
    ...
    DiscreteTimeIntegrator1_DSTATE = tmp_a[0];
    rtb_RL_dot_0 = tmp_a[1];
    localProduct += tmp[3 * i + 2] * rtb_MatrixMultiply9[i];
  }

  Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[0] +=
    Base_Model_P.DiscreteTimeIntegrator3_gainval *
    DiscreteTimeIntegrator1_DSTATE;
  Base_Model_DW.UnitDelay_DSTATE[0] = rtb_Sum4[0];
  Base_Model_DW.UnitDelay_DSTATE[3] = rtb_MatrixMultiply10[0];
  Base_Model_DW.UnitDelay_DSTATE[6] = rtb_Transpose1[0];
  Base_Model_DW.UnitDelay_DSTATE[9] = rtb_Transpose2[0];
  _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_set_pd(rtb_Product5[0], rtb_Product4[0]),
    _mm_set_pd(rtb_pH2_dot[0], rtb_pH1_dot[0])));
  Base_Model_DW.UnitDelay_DSTATE_n[0] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_o[0] = tmp_a[1];
  _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_set_pd(rtb_Product7[0], rtb_Product6[0]),
    _mm_set_pd(rtb_pH4_dot[0], rtb_pH3_dot[0])));
  Base_Model_DW.UnitDelay_DSTATE_c[0] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_i[0] = tmp_a[1];
  Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[1] +=
    Base_Model_P.DiscreteTimeIntegrator3_gainval * rtb_RL_dot_0;
  Base_Model_DW.UnitDelay_DSTATE[1] = rtb_Sum4[1];
  Base_Model_DW.UnitDelay_DSTATE[4] = rtb_MatrixMultiply10[1];
  Base_Model_DW.UnitDelay_DSTATE[7] = rtb_Transpose1[1];
  Base_Model_DW.UnitDelay_DSTATE[10] = rtb_Transpose2[1];
  _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_set_pd(rtb_Product5[1], rtb_Product4[1]),
    _mm_set_pd(rtb_pH2_dot[1], rtb_pH1_dot[1])));
  Base_Model_DW.UnitDelay_DSTATE_n[1] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_o[1] = tmp_a[1];
  _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_set_pd(rtb_Product7[1], rtb_Product6[1]),
    _mm_set_pd(rtb_pH4_dot[1], rtb_pH3_dot[1])));
  Base_Model_DW.UnitDelay_DSTATE_c[1] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_i[1] = tmp_a[1];
  Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[2] +=
    Base_Model_P.DiscreteTimeIntegrator3_gainval * localProduct;
  Base_Model_DW.UnitDelay_DSTATE[2] = rtb_Sum4[2];
  Base_Model_DW.UnitDelay_DSTATE[5] = rtb_MatrixMultiply10[2];
  Base_Model_DW.UnitDelay_DSTATE[8] = rtb_Transpose1[2];
  Base_Model_DW.UnitDelay_DSTATE[11] = rtb_Transpose2[2];
  _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_set_pd(rtb_Product5[2], rtb_Product4[2]),
    _mm_set_pd(rtb_pH2_dot[2], rtb_pH1_dot[2])));
  Base_Model_DW.UnitDelay_DSTATE_n[2] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_o[2] = tmp_a[1];
  _mm_storeu_pd(&tmp_a[0], _mm_add_pd(_mm_set_pd(rtb_Product7[2], rtb_Product6[2]),
    _mm_set_pd(rtb_pH4_dot[2], rtb_pH3_dot[2])));
  Base_Model_DW.UnitDelay_DSTATE_c[2] = tmp_a[0];
  Base_Model_DW.UnitDelay_DSTATE_i[2] = tmp_a[1];
  fmu_LogOutput();
}
...
{
  {
    ...
    Base_Model_DW.DiscreteTimeIntegrator3_DSTATE[2] =
      Base_Model_P.DiscreteTimeIntegrator3_IC;
    for (i = 0; i < 12; i++) {
      Base_Model_DW.UnitDelay_DSTATE[i] =
        Base_Model_P.UnitDelay_InitialCondition;
    }

    Base_Model_DW.UnitDelay_DSTATE_n[0] =
      Base_Model_P.UnitDelay_InitialCondition_k;
    Base_Model_DW.UnitDelay_DSTATE_o[0] =
      Base_Model_P.UnitDelay_InitialCondition_b;
    Base_Model_DW.UnitDelay_DSTATE_c[0] =
      Base_Model_P.UnitDelay_InitialCondition_e;
    Base_Model_DW.UnitDelay_DSTATE_i[0] =
      Base_Model_P.UnitDelay_InitialCondition_i;
    Base_Model_DW.UnitDelay_DSTATE_n[1] =
      Base_Model_P.UnitDelay_InitialCondition_k;
    Base_Model_DW.UnitDelay_DSTATE_o[1] =
      Base_Model_P.UnitDelay_InitialCondition_b;
    Base_Model_DW.UnitDelay_DSTATE_c[1] =
      Base_Model_P.UnitDelay_InitialCondition_e;
    Base_Model_DW.UnitDelay_DSTATE_i[1] =
      Base_Model_P.UnitDelay_InitialCondition_i;
    Base_Model_DW.UnitDelay_DSTATE_n[2] =
      Base_Model_P.UnitDelay_InitialCondition_k;
    Base_Model_DW.UnitDelay_DSTATE_o[2] =
      Base_Model_P.UnitDelay_InitialCondition_b;
    Base_Model_DW.UnitDelay_DSTATE_c[2] =
      Base_Model_P.UnitDelay_InitialCondition_e;
    Base_Model_DW.UnitDelay_DSTATE_i[2] =
      Base_Model_P.UnitDelay_InitialCondition_i;
  }
}
