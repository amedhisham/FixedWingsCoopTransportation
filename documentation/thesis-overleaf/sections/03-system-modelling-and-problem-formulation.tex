...
controlling the internal forces $f_\lambda(t)$.
...
train a Neural Network (NN) to mimic the output of the optimizer. This 
dramatically reduces the computational cost allowing the trajectories to be
calculated online. We face
