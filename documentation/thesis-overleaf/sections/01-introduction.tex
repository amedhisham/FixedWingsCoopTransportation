...
multirotors. Recent works by [3],[4] and [5] showed that it is possible to
calculate coordinated trajectories for the carriers online, such trajectories
would respect the non-stopping condition while also maintaining load tracking. 
The solution however, was based
...
Reinforcement Learning (RL) provides a natural framework for learning control 
policies in such uncertain and partially observable environments.Finally, 
the problem has many other aspects that are beyond the scope of
